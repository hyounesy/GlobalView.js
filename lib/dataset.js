  ...
  */
  ...
  this.requestDensityMap = function (d0, d1, size, options, ondone) {
    ...
    if (isAsync) {
      ...
      if (!densityMap) {
        ...
        _densityMaps[d0][d1] = densityMap = new libAlgorithm.DensityMap(libAlgorithm.computeDensityMap(_histogram, new libAlgorithm.DensityMapOptions(options)));
  ...
  this['save'] = this.save = function (filename, nameColumn, nameColumnLabel) {
    ...
    for (var i = 0; i < this.length; ++i) {
      ...
      for (var _c3 = 0, _ci = 0; _c3 < csv_nc; ++_c3, ++_ci) {
        if (_c3 === nameColumn) {
...
function CsvDataset(file, options, onload) {
  ...
  var parseCsv = function parseCsv(csv) {
    ...
    var n = data.length;
    var nc = data[0].length - (options['nameColumn'] ? 1 : 0);
    var firstRow = options['hasHeader'] ? 1 : 0;
    ...
    var i = void 0,
        di = void 0;
    for (var _c4 = 0, _ci2 = 0; _c4 < data[0].length; ++_c4, ++_ci2) {
      if (_c4 === options['nameColumn']) {
        --_ci2;
        continue;
      }
      ...
      if (!isNumeric) {
        ...
        for (i = firstRow, di = 0; i < data.length; ++i, ++di) {
          ...
          if (typeof cls === 'undefined') {
            ...
            _fvalue = _valueMap[_value2] = valueIdx++;
          } else {
            _fvalue = cls;
          }
      ...
      dataset.columns.push({ minimum: min, maximum: max, label: columnLabels ? columnLabels[_ci2] : options['hasHeader'] ? data[0][_c4] : generateColumnName(_ci2, nc), values: valueList });
