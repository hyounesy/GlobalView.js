...
function Dataset() {
  ...
  */
  ...
  this.inflate = function fInflate(factor, densityMapChain) {
    ...
    for (var _i2, iInflated = n, _len2 = n * nc; iInflated < nInflated; iInflated += 1) {
      _i2 = iInflated % n;
      ...
      for (var c = 0; c < nc; c += 1) {
        ...
        if (column.values) {
          ...
          fdataInflated[iInflated * nc + c] = sample = Math.max(0, Math.min(column.values.length - 1, Math.round(sample)));
    ...
    if (this.names !== null) {
      ...
      for (var _i3 = 0, _len3 = n; _i3 < _len3; _i3 += 1) {
        namesInflated[_i3] = names[_i3];
      }
      for (var index = 0, _iInflated = n, _len4 = n * nc; _iInflated < nInflated; _iInflated += 1) {
    ...
    if (this.imageFilenames !== null) {
      ...
      for (var _i4 = 0, _len5 = n; _i4 < _len5; _i4 += 1) {
        imageFilenamesInflated[_i4] = imageFilenames[_i4];
      }
      for (var _iInflated2 = n, _len6 = n * nc; _iInflated2 < nInflated; _iInflated2 += 1) {
