...
function findClosePointOfLowDensity(dataset, d0, d1, p, densityMap, stencilMap, minDistX, minDistY) {
  ...
  var xmin = Math.min(0, Math.floor(densityMap.transformX(v0.minimum)) - minDMDistX - 1); // TODO: -1 ... Why?
  var xmax = Math.max(width, Math.ceil(densityMap.transformX(v0.maximum)) + minDMDistX + 2); // TODO: +2 ... Why?
  var ymin = Math.min(0, Math.floor(densityMap.transformY(v1.minimum)) - minDMDistY - 1); // TODO: -1 ... Why?
  var ymax = Math.max(height, Math.ceil(densityMap.transformY(v1.maximum)) + minDMDistY + 2); // TODO: +2 ... Why?
