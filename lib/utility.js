...
exports.rgbStringToFloatArray = rgbStringToFloatArray;
exports.i24ToFloatArray = i24ToFloatArray;
exports.F32toI24 = F32toI24;
exports.F32toI24flipY = F32toI24flipY;
exports.hsv2rgb = hsv2rgb;
exports.urlExists = urlExists;
exports.download = download;
exports.imageUrlFromBytes = imageUrlFromBytes;
exports.createCookie = createCookie;
exports.readCookie = readCookie;
exports.readFloatCookie = readFloatCookie;
exports.readIntCookie = readIntCookie;
exports.eraseCookie = eraseCookie;
exports.getParameterByName = getParameterByName;
exports.addMouseWheelHandler = addMouseWheelHandler;
exports.addMouseMoveHandler = addMouseMoveHandler;
exports.addMouseUpHandler = addMouseUpHandler;
exports.addKeyDownHandler = addKeyDownHandler;
exports.addKeyUpHandler = addKeyUpHandler;
...
if (!String.prototype.format) {
  ...
  String.prototype.format = function (args) {
    var varArgs = arguments; // eslint-disable-line prefer-rest-params
...
String.prototype.format2 = function (pattern, mismatch, args) {
  ...
  return this.replace(pattern, function (match, strNumber) {
    var number = Number.parseInt(strNumber, 10) + 2;
...
function hexToRgb(pHex) {
  // Source: https://stackoverflow.com/a/5624139
  // Expand shorthand form (e.g. "03F") to full form (e.g. "0033FF")
  var shorthandRegex = /^#?([a-f\d])([a-f\d])([a-f\d])$/i;
  var hex = pHex.replace(shorthandRegex, function (m, r, g, b) {
    return r + r + g + g + b + b;
  });
...
function F32toI24(floats, bounds) {
  ...
  var i = 0;
  var voffset = -bounds[0];
  var vscale = 0xFFFFFE / (bounds[1] - bounds[0]);
...
function hsv2rgb(hsv) {
  ...
  var q = hsv[2] * (1.0 - hsv[1] * ff);
  var t = hsv[2] * (1.0 - hsv[1] * (1.0 - ff));
...
function getParameterByName(pName, pUrl) {
  ...
  var name = pName.replace(/[\[\]]/g, '\\$&'); // eslint-disable-line no-useless-escape
...
function ForwardList(value) {
  ...
  this.pushBack = function (val) {
    ...
    var newnode = new ForwardList(val);
    back.next = newnode;
  };
...
function PriorityQueue(priorityProperty) {
  ...
  this.push = function (element) {
    this.length += 1;
    var i = void 0;
    var p = element[priorityProperty];
...
function HashSet(onchanged) {
  ...
  this.assign = function (values) {
    ...
    // var t = performance.now();
    var newHash = {};
    var identical = values.length === this.length;
    values.forEach(function (value) {
