...
function PointViewer(gl, globalView) {
  ...
  this.render = function (flipY, tf, colormapTexture, pointDrag) {
    ...
    meshDataPoints.sdr.offsets.apply(meshDataPoints.sdr, tf.getOffsets()); // eslint-disable-line prefer-spread
    meshDataPoints.sdr.scales.apply(meshDataPoints.sdr, tf.getScales()); // eslint-disable-line prefer-spread
    meshDataPoints.sdr.animatedScales.apply(meshDataPoints.sdr, tf.getAnimatedScales()); // eslint-disable-line prefer-spread
    ...
    if (pointDrag) {
      ...
      meshDataPoints.sdrLine.offsets.apply(meshDataPoints.sdrLine, tf.getOffsets()); // eslint-disable-line prefer-spread
      meshDataPoints.sdrLine.scales.apply(meshDataPoints.sdrLine, tf.getScales()); // eslint-disable-line prefer-spread
      meshDataPoints.sdrLine.animatedScales.apply(meshDataPoints.sdrLine, tf.getAnimatedScales()); // eslint-disable-line prefer-spread
  ...
  function DataMesh(gl, posbuffer, numvertices, ndim, options) {
    ...
    this.draw = function (texture, offset, count) {
      ...
      for (var _i2 = 0; _i2 < 16; _i2 += 1) {
        ...
        if (gl.ext) {
          gl.ext.vertexAttribDivisorANGLE(_i2, 0);
        }
      }
      ...
      if (posbuffer) {
        ...
        for (var d = 0, _i3 = 0; d < ndim; d += 4, _i3 += 1) {
          if (this.sdr.posattr[_i3] !== -1) {
            gl.enableVertexAttribArray(this.sdr.posattr[_i3]);
            gl.vertexAttribPointer(this.sdr.posattr[_i3], Math.min(4, ndim - d), gl.FLOAT, false, ndim * 4, (offset * ndim + d) * 4);
          }
        }
      }
    ...
    this.drawIndexed = function (texture, idxbuffer, count) {
      for (var _i4 = 0; _i4 < 16; _i4 += 1) {
        ...
        if (gl.ext) {
          gl.ext.vertexAttribDivisorANGLE(_i4, 0);
        }
      }
      ...
      if (posbuffer) {
        ...
        for (var d = 0, _i5 = 0; d < ndim; d += 4, _i5 += 1) {
          if (this.sdr.posattr[_i5] !== -1) {
            gl.enableVertexAttribArray(this.sdr.posattr[_i5]);
            gl.vertexAttribPointer(this.sdr.posattr[_i5], Math.min(4, ndim - d), gl.FLOAT, false, ndim * 4, d * 4);
          }
        }
      }
    ...
    this.drawLines = function (texture, line, offset, count) {
      ...
      for (var _i6 = 0; _i6 < 16; _i6 += 1) {
        gl.disableVertexAttribArray(_i6);
        gl.ext.vertexAttribDivisorANGLE(_i6, 0);
      }
      ...
      if (posbuffer) {
        ...
        for (var d = 0, _i7 = 0; d < ndim; d += 4, _i7 += 1) {
          if (this.sdrLine.posattr[_i7] !== -1) {
            gl.enableVertexAttribArray(this.sdrLine.posattr[_i7]);
            gl.vertexAttribPointer(this.sdrLine.posattr[_i7], Math.min(4, ndim - d), gl.FLOAT, false, ndim * 4, (offset * ndim + d) * 4);
            gl.ext.vertexAttribDivisorANGLE(this.sdrLine.posattr[_i7], 1);
          }
        }
      }
