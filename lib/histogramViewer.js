...
function HistogramViewer(gl, globalView) {
  ...
  function createHistogram(axis, dataset, d, numBins) {
    ...
    for (var _b = 0, _i = -1, _x_scale = 1 / numBins; _b < numBins; ++_b) {
      var _y = axis.histogram.data[_b] / axis.histogram.maximum;

      v3_set(++_i, (_b + 0) * _x_scale, 0);
      v3_set(++_i, (_b + 1) * _x_scale, 0);
      v3_set(++_i, (_b + 1) * _x_scale, _y);

      v3_set(++_i, (_b + 1) * _x_scale, _y);
      v3_set(++_i, (_b + 0) * _x_scale, _y);
      v3_set(++_i, (_b + 0) * _x_scale, 0);
    }
